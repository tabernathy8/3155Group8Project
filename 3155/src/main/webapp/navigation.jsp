    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            <div class ="topnav" id = "myTopnav">
                ...
                <c:if test="${city == null}">
                    <form method="get" action="fiveday"><input type="submit" value = "4 Day Forecast" name="action"><input type="hidden" value="Charlotte" name="city"/></form>
                </c:if>
                <c:if test="${city != null}">
                <form method="get" action="fiveday"><input type="submit" value = "4 Day Forecast" name="action"><input type="hidden" value="${city}" name="city"/></form>
                </c:if>
                
                <form class = "right" method = "get" action="weather" style="padding-top: 15px;"><input style = "padding-top: 15px; padding-bottom: 15px; border-style: none; background-color: black; color: white; border-color: white;" type="text" name="city" placeholder = "Enter your cities name"><input type="hidden" value="home" name="action"></form>
